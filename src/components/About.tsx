    ...
    <section id="about" className="py-20 px-6 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Personal Info */}
          <div className="glass-effect rounded-2xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 border border-gray-100 p-8">
          ...
          <div className="glass-effect rounded-2xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 border border-gray-100 p-8">
            ...
            <div className="space-y-6">
              <div className="relative pl-6 border-l-2 border-gray-100">
                ...
                <p className="text-gray-600 text-sm">Explored key areas of digital marketing including social media marketing, SEO, and brand reputation building.</p>
              </div>
              ...
              <div className="relative pl-6 border-l-2 border-gray-100">
                ...
                <p className="text-gray-600 text-sm">Focused on learning the basics of data analytics tools, their usage, and application in marketing insights.</p>
              </div>
              ...
              <div className="relative pl-6 border-l-2 border-gray-100">
                ...
                <p className="text-gray-600 text-sm">Managed AI influencer page (70k+ followers) and co-founded REI Clan for content creators.</p>
              </div>
            </div>
          </div>
          ...
          <div className="glass-effect rounded-2xl shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 border border-gray-100 p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="relative pl-6 border-l-2 border-gray-100">
                ...
                <a href="https://coursera.org/share/6e7515b9470f0d593ff2cdbdc1c0d789" target="_blank" rel="noopener noreferrer" className="text-secondary font-medium hover:underline flex items-center mt-1 text-sm">
                  View Certificate
                </a>
              </div>
        ...
        <div className="mt-12 p-8 rounded-2xl border border-gray-100 bg-gradient-to-r from-primary/5 to-secondary/5 backdrop-blur-sm shadow-lg">
          <h3 className="text-2xl font-bold mb-4 text-primary">My Approach</h3>
